    ...
    return (
        <div className='bg-black'>
            <Container className='custom_container'>
                <h2 className='mb-0 ff-jakarta fw-bolder fs-xl text-white bg-black lh-120 text-center py-4'>Amplify and <span className='text-uppercase'>stretch gains</span></h2>
            </Container>
